...
('angostura bitters','bitters','bitters','bitters are to cocktails as salt to food. they help improve and align flavor as well as bring their own', 1),
('orange bitters','bitters','bitters', 'made from orange peels, cardamom, caraway seed, coriander, anise, burnt sugar', 1),
('simple syrup', 'sugar', 'sugar', '1 to 1 ratio of sugar and water', 1),
('rich syrup', 'sugar','sugar', '2 to 1 ratio of sugar and water', 1),
('egg white','texture','protein', 'Adding eggs to shaken drinks is a tradition that dates back more than a century. always buy the freshest eggs available', 1),
...
INSERT INTO "ingredients" ("name", "ingredient_type", "quality", "user_id")
...
CREATE TABLE "cocktails" (
	...
	"glassware_id" int REFERENCES "glassware" NULL,
...
VALUES
	('Whiskey Sour');
	INSERT INTO "cocktails"
	("name", "description", "instructions", "glassware_id", "user_id")
VALUES ('Paper Tiger', 'a cool riff on a paper plane', 'combine ingredients,
 Shake vigorousesly, double strain into chilled coupe', 7, 3);

-- now that everything is set up we can make a cocktaile with our tables 
INSERT INTO "cocktails_ingredients" ("cocktail_id", "ingredient_id", "measurement_type", "number")
VALUES
	(3, 1, 'ounces', 0.25), --papertiger lemon juice, ounces, 0.25
	(3, 2, 'ounces', 0.25), --papertiger lime juice,  ounces , 0.25
	(3, 14, 'ounces', 0.75), --papertiger bourbon, ounces, 0.75
	(3, 64, 'ounces', 0.75), --papertiger thyme simple syrup, ounces, 0.75
	(3, 65, 'ounces', 0.75), --papertiger Aperol, ounces, 0.75
	(3, 72, 'ounces', 0.75); --papertiger amaro noninio , ounces 0.75
...
--FROM "ingredients"
--JOIN "cocktails_ingredients"
--	ON "ingredients".id = "cocktails_ingredients".ingredients_id
--JOIN "cocktails"
--	ON "cocktails_ingredients".cocktail_id = "cocktails".id
--JOIN "cocktails_spirits"
